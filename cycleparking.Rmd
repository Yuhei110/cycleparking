...
gp=
  ...
  tm_polygons(col = "porCurrentCat", 
              palette = col_pocu,
              title = "Current Parking Occupancy")+
  tm_layout(legend.title.size = 0.9,
            legend.text.size = 0.7,
            legend.outside = TRUE,
            legend.outside.position = "bottom",
...
tmap_save(gp, file="output/fig5_1_ParkingOccupancyMap.png", dpi =600, width=3, height=3.5)
...
ggsave(file="output/fig5_2_ParkingOccupancy.png", plot=gp, dpi =600, width=3, height=3)
