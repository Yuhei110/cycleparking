...
gp2a=
  ...
  tm_layout(legend.title.size = 0.2,
            legend.text.size = 0.2,
            legend.outside = FALSE,
            legend.outside.position = c("right","bottom"),
            main.title.size = 0.4,
            frame = FALSE,
            main.title = "Current number of cycle commuters"
            ) 

tmap_save(gp2a, file="output/fig2a_CurrentNoCyclists.png", dpi =600, width=3, height=3.5)
...
gp2b=
  ...
  tm_layout(legend.title.size = 0.2,
            ...
            main.title.size = 0.4,
            frame = FALSE,
            main.title = "Possible growth in cycle commuters"
            ) 

tmap_save(gp2b, file="output/fig2b_IncreaseNoCyclists.png", dpi =600, width=3, height=3.5)
...
gp2c= 
  ...
  tm_layout(legend.title.size = 0.2,
            ...
            main.title.size = 0.4,
            frame = FALSE,
            main.title = c("Current Cycle modal share")
            ) 

tmap_save(gp2c, file="output/fig2c_PctCyclists.png", dpi =600, width=3, height=3.5)
...
gp2d= 
  ...
  tm_layout(legend.title.size = 0.2,
            ...
            main.title.size = 0.4,
            frame = FALSE,
            main.title = "Current cycle parking spaces"
            ) 

tmap_save(gp2d, file="output/fig2d_ParkingSupply.png", dpi =600, width=3, height=3.5)
gp2 <- tmap_arrange(gp2a, gp2b, gp2c, gp2d, outer.margins = 0)
tmap_save(gp2, file="output/fig2_All.png", dpi =600, width=3, height=3.5)
...
test = ggplot(census3, aes(x = CurrentShare, y = GrowthNosGE)) +
  ...
  labs(y="Possible growth in cycle commuters", x = "Current cycling commuter modal share")+
...
tmap_save(gp4, file="output/fig4_ModeShareMatrix.png", dpi =600, width=6, height=5)
...
gp5a=
  ...
  tm_polygons(col = "porCurrentCat", 
              ...
              title = "",
              lwd = 0.2)+
  tm_layout(legend.title.size = 0.4,
...
tmap_save(gp5a, file="output/fig5_1_ParkingOccupancyMap.png", dpi =600, width=3, height=3.5)
...
gp5b=
  ...
  labs(y="No. of bicycle commuters", x = "Parking Occupancy Category")+
  theme(legend.position = "None",
        axis.text=element_text(size=6),
        axis.title=element_text(size=8,face="bold")) 

ggsave(file="output/fig5_2_ParkingOccupancy.bmp", plot=gp5b, dpi =600, width=2.9, height=2.9)
...
ggsave(file="output/fig6_1_ParkingOccupancyCount.png", plot=gp, dpi =600, width=3, height=3)
...
ggsave(file="output/fig6_2_ParkingOccupancyPct.png", plot=gp, dpi =600, width=3, height=3)
